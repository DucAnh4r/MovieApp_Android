...
public class NotificationActivity extends AppCompatActivity {
        ...
        userRef.addListenerForSingleValueEvent(new ValueEventListener() {
            ...
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                for (DataSnapshot messageSnapshot : dataSnapshot.child("message").getChildren()) {
                    ...
                    String slug = null;
                    if (messageSnapshot.child("slug").exists()) {
                        slug = messageSnapshot.child("slug").getValue(String.class);
                    }
                    NotificationMessage message = new NotificationMessage(content, timestamp, type, slug);
                    messageList.add(message);
                }
                ArrayList<NotificationMessage> reversedList = new ArrayList<>(messageList);
                Collections.reverse(reversedList);
                NotificationAdapter adapter = new NotificationAdapter(reversedList);
    ...
    private void initView() {
        ...
        more.setOnClickListener(v -> {
            Intent intent = new Intent(NotificationActivity.this, MovieTypeActivity.class);
