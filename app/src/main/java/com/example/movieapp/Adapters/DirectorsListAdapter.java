...
public class DirectorsListAdapter extends RecyclerView.Adapter<DirectorsListAdapter.ActorViewHolder> {
    private List<ActorModel> actorsList;

    public DirectorsListAdapter(List<ActorModel> actorsList) {
