...
public class EpisodeSearchAdapter extends RecyclerView.Adapter<EpisodeSearchAdapter.ViewHolder> {
    ...
    public EpisodeSearchAdapter(Context context, List<Episode> episodeList, String slug, String searchInput) {
